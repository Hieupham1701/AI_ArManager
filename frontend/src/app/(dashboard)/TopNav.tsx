    ...
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white">
      <div className="flex w-full items-center gap-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            type="button"
            className="flex items-center gap-2 whitespace-nowrap rounded-lg px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-[#2B85FF]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
