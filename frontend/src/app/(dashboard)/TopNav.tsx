  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white">
      <div className="flex w-full items-center gap-6 px-4 sm:px-6 lg:px-8">
        <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#2B85FF]">
          <svg
            ...
            return (
              <Link
                ...
                className={`whitespace-nowrap border-b-2 px-3 py-4 text-sm font-medium transition ${active
                  ? "border-[#2B85FF] text-[#2B85FF]"
                  : "border-transparent text-slate-600 hover:border-blue-200 hover:text-[#2B85FF]"
                  }`}
              >
                {item.label}
              </Link>
        ...
        <div className="ml-auto flex items-center gap-2">
          <button
            ...
            className="relative flex h-9 w-9 items-center justify-center rounded-full text-slate-500 transition hover:bg-slate-100 hover:text-[#2B85FF]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <button
            ...
            className="flex items-center gap-2 whitespace-nowrap rounded-lg px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-[#2B85FF] disabled:cursor-not-allowed disabled:opacity-60"
